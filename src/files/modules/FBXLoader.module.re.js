...
import NURBSCurve from './curves/NURBSCurve.js';
	...
	export default function FBXLoader( manager ) {//THREE.FBXLoader = function ( manager )
		this.manager = ( manager !== undefined ) ? manager : THREE.DefaultLoadingManager;
	};
	Object.assign( FBXLoader.prototype, {//THREE.
		load( url, onLoad, onProgress, onError ) {//: function 
			var self = this;
			...
			loader.load( url, ( buffer ) => {//loader.load( url, function ( buffer )
				try {
		...
		parse ( FBXBuffer, resourceDirectory ) {//: function
			var FBXTree;
	...
	var GetData = {
		...
		ByPolygonVertex: {
			...
			Direct( polygonVertexIndex, polygonIndex, vertexIndex, infoObject ) {//: function 
			...
			IndexToDirect ( polygonVertexIndex, polygonIndex, vertexIndex, infoObject ) {//: function
	...
	function parseNurbsGeometry( geometryNode ) {
		...
		var curve = NURBSCurve( degree, knots, controlPoints, startKnot, endKnot );//new THREE.
	...
	Object.assign( TextParser.prototype, {
		...
		setCurrentProp ( val, name ) {//: function
		...
		parseNodeBegin ( line, property ) {//: function
		...
		parseNodeProperty ( line, property, contentLine ) {//: function
		...
		parseNodePropertyContinued ( line ) {//: function
		...
		// parse "Property70"
		parseNodeSpecialProperty ( line, propName, propValue ) {//: function
	...
	Object.assign( BinaryParser.prototype, {
		...
		parseNode ( reader, version ) {//: function
		...
		parseSubNode ( name, node, subNode ) {//: function
